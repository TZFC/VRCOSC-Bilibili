...
class OSCManager:
    ...
    def setup(self, client_ip: str, client_port: int, server_ip: str, server_port: int, on_message: Callable):
    ...
    async def start_server(self):
        ...
        self.server = AsyncIOOSCUDPServer((self.server_ip, self.server_port), self.dispatcher, loop)
